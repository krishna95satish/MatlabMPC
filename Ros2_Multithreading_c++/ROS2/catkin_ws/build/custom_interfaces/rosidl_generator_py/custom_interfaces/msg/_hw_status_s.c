...
bool custom_interfaces__msg__hw_status__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("custom_interfaces.msg._hw_status.HwStatus", full_classname_dest, 41) == 0);
  }
  custom_interfaces__msg__HwStatus * ros_message = _ros_message;
  {  // temperature
...
{
  /* NOTE(esteve): Call constructor of HwStatus */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("custom_interfaces.msg._hw_status");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "HwStatus");
