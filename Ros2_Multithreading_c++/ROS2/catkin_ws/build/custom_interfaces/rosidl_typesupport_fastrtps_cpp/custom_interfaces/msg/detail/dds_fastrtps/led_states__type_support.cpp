...
#include "custom_interfaces/msg/detail/led_states__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
bool cdr_serialize(
  const custom_interfaces::msg::LEDState &,
  eprosima::fastcdr::Cdr &);
bool cdr_deserialize(
  eprosima::fastcdr::Cdr &,
  custom_interfaces::msg::LEDState &);
...
cdr_serialize(
  const custom_interfaces::msg::LEDStates & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  custom_interfaces::msg::LEDStates & ros_message)
{
  // Member: led_status
  {
    for (size_t i = 0; i < 3; i++) {
  ...
  // Member: led_status
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        ...
        ros_message.led_status[index], current_alignment);
    }
  }
  ...
  size_t current_alignment)
{
  ...
  // Member: led_status
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        custom_interfaces::msg::typesupport_fastrtps_cpp::max_serialized_size_LEDState(
...
{
  auto typed_message =
    static_cast<const custom_interfaces::msg::LEDStates *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<custom_interfaces::msg::LEDStates *>(
    untyped_ros_message);
...
{
  return &custom_interfaces::msg::typesupport_fastrtps_cpp::_LEDStates__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, custom_interfaces, msg, LEDStates)() {
  return &custom_interfaces::msg::typesupport_fastrtps_cpp::_LEDStates__handle;
}
