...
{
  new (message_memory) custom_interfaces::msg::HwStatus(_init);
}

void HwStatus_fini_function(void * message_memory)
{
  auto typed_message = static_cast<custom_interfaces::msg::HwStatus *>(message_memory);
  typed_message->~HwStatus();
}

static const ::rosidl_typesupport_introspection_cpp::MessageMember HwStatus_message_member_array[3] = {
  {
    "temperature",  // name
    ...
    offsetof(custom_interfaces::msg::HwStatus, temperature),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(custom_interfaces::msg::HwStatus, are_motors_ready),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(custom_interfaces::msg::HwStatus, debug_message),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers HwStatus_message_members = {
  ...
  3,  // number of fields
  sizeof(custom_interfaces::msg::HwStatus),
...
{
  return &::custom_interfaces::msg::rosidl_typesupport_introspection_cpp::HwStatus_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, custom_interfaces, msg, HwStatus)() {
  return &::custom_interfaces::msg::rosidl_typesupport_introspection_cpp::HwStatus_message_type_support_handle;
}
