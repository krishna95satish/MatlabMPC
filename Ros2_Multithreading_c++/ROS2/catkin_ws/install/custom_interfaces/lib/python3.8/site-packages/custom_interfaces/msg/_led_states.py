    ...
    def __import_type_support__(cls):
        try:
            ...
            logger = logging.getLogger(
                'custom_interfaces.msg.LEDStates')
            logger.debug(
            ...
            if LEDState.__class__._TYPE_SUPPORT is None:
                LEDState.__class__.__import_type_support__()
...
class LEDStates(metaclass=Metaclass_LEDStates):
    ...
    _fields_and_field_types = {
        'led_status': 'custom_interfaces/LEDState[3]',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.Array(rosidl_parser.definition.NamespacedType(['custom_interfaces', 'msg'], 'LEDState'), 3),  # noqa: E501
    )
        ...
        if __debug__:
            ...
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 len(value) == 3 and
                 all(isinstance(v, LEDState) for v in value) and
                 True), \
                "The 'led_status' field must be a set or sequence with length 3 and each value of type 'LEDState'"
